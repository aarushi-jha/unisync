                ...
                <div class="middle-sidebar-left">
                    ...
                    <div class="row feed-body">
                        <div class="col-xl-8 col-xxl-9 col-lg-8">
                            ...
                            <?php 
                                $sql22 = "SELECT college_connection.*,college_users.name FROM college_connection JOIN college_users on college_connection.user_id2=college_users.id  where college_connection.status='1' AND college_connection.user_id1='".$_SESSION['id']."'";
                                    ...
                                    if (mysqli_num_rows($res22) > 0) {
                                        while ($row22 = mysqli_fetch_array($res22)) {
                                                ...
                                                <div class="card-body d-flex pt-4 ps-4 pe-4 pb-0 border-top-xs bor-0">
                                                    ...
                                                    <h4 class="fw-700 text-grey-900 font-xssss mt-1"><?php echo $row22['name'] ?> <span class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">Student</span></h4>
                                                </div>
                                            <?php
                                        }
                                    }
